        ...
        >
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    ...
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Tạ Thái</div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            ...
            <ul>
                ...
                <RouterLink to="/library">
                    <MenuItem class="ml-[2px]" :iconSize="23" name="Thư viện của bạn" iconString="library" pageUrl="/library" />
                </RouterLink>
                <div class="py-3.5"></div>
                <MenuItem :iconSize="24" name="Tạo Danh sách mới" iconString="playlist" pageUrl="/playlist" />
                <MenuItem class="-ml-[1px]" :iconSize="27" name="Bài hát yêu thích" iconString="liked" pageUrl="/liked" />
            </ul>
            <div class="border-b border-b-gray-700"></div>
            <ul>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Danh sách phát #1</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Danh sách phát #2</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Danh sách phát #3</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Danh sách phát #4</li>
            </ul>
        </div>
    </div>
